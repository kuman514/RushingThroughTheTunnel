...
def game():
    ...
    stages = ((1, Enemies.Enemy(100, 10, pygame.image.load('enemy1.png')), 25, 50, 6, 1, 20),
              (2, Enemies.Enemy(120,  8, pygame.image.load('enemy2.png')), 20, 45, 7, 1, 25),
              (3, Enemies.Enemy(150,  7, pygame.image.load('enemy3.png')), 15, 40, 7, 1, 36))
    level = 1
